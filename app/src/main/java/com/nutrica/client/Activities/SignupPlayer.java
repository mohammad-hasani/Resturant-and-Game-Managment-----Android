            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    String query = "no query" + G.spliter + "signup" + G.spliter + level + G.spliter +
                            name + G.spliter + username + G.spliter + password;
                            ...
                            switch (data) {
                                case "duplicate username":
                                    runOnUiThread(new Runnable() {
                                        @Override
                                        public void run() {
                                            Toast.makeText(getApplicationContext(), getString(R.string.duplcate_username), Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                    break;
                                default:
                                    final int id = Integer.valueOf(data);
                                    runOnUiThread(new Runnable() {
                                        @Override
                                        public void run() {
//                                    showProgress(false);
