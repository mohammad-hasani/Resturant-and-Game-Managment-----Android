...
import com.nutrica.client.Tools.*;
...
//        Spinner spinnerLoginType = (Spinner)findViewById(R.id.spinner_login_type);
//        spinnerLoginType.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
//            @Override
//            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
//                G.loginType = Enums.login_type.values()[i - 1];
//            }
//
//            @Override
...
//        fillLoginTypeSpinner(spinnerLoginType);
    }
...
//                    String query = String.format("select id from tbl_admin where username='%s' and password='%s' and type='%s'", username, password, "a");
                    ...
                    if (data != null && !data.equals("false") && !data.equals("None") && data.length() > 0) {
                        ...
                        startActivity(new Intent(LoginActivityAdmin.this, MainActivity.class));
                    }
...
//    private void fillLoginTypeSpinner(Spinner spinnerLoginType)
//    {
//        ArrayList<String> categories = new ArrayList<>();
//        categories.add("Login Type : ");
//        categories.add("Admin");
//        categories.add("Player");
//
//        ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, categories);
//        dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
//        spinnerLoginType.setAdapter(dataAdapter);
//    }
//
