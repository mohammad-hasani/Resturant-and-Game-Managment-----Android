...
import com.nutrica.client.Tools.DividerItemDecoration;
...
public class GameStreamLeague extends Fragment {
...
//        recyclerView.addItemDecoration(new DividerItemDecoration(view.getContext(), LinearLayoutManager.VERTICAL));
    ...
    private void prepareGameData() {
        ...
        String query = "select tbl_league_playing.id, tbl_user.name from tbl_league_playing\n" +
                "join tbl_user\n" +
                "join tbl_league_playing_user\n" +
                "on \n" +
                "tbl_league_playing_user.id_league_playing=tbl_league_playing.id \n" +
                "and \n" +
                "tbl_league_playing_user.id_user=tbl_user.id";
